...
import com.parcar.view.modal.MdGestionarTarifa;
...
public class FrmGestionarTarifa extends javax.swing.JInternalFrame {

    public static TarifaController tarifaC = new TarifaController();
    
    public FrmGestionarTarifa() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto){
        ...
        String columnas[] = {"#","Monto hora","Monto Día","Tipo","","",""};
        ...
        if (txtBuscar.getText().length() == 0) {
            lista = tarifaC.listar();
        } else {
            lista = tarifaC.listar(texto);
        }
        ...
        for (Object obj : lista) {
            ...
            modelo.addRow(new Object[]{
                ...
                tarifa.getMontohora(),
                tarifa.getMontoDía(),
                tarifa.getTipoVehiculo().getDescripcion(),
                botonModificar,
                botonEliminar,
                botonVer
            });
        ...
        tblListado.getColumnModel().getColumn(3).setPreferredWidth(205);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        MdGestionarTarifa frm = new MdGestionarTarifa();
                ...
                switch (boton.getName()) {
                    case "btnEliminar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            Alerta alerta = new Alerta("Alerta", "Debe seleccionar un tarifa");
                        } else {
                            String valor = String.valueOf(tblListado.getValueAt(fila, 3));

                            int opcion = JOptionPane.showConfirmDialog(null, "¿Está seguro de eliminar al tarifa " + valor + "?", "Confirmar", 2);
                            if (opcion == 0) {

                                try {
                                    tarifaC.eliminar(id);
                                    AlertaBien alertaBien = new AlertaBien("Mensaje", "tarifa eliminado correctamente!");
                                    listar("");
                                } catch (Exception ex) {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            MdGestionarTarifa.idTarifa = id;
                            FrmMenuPrincipal.centrarVentana(new MdGestionarTarifa());
                            MdGestionarTarifa.btnGrabar.setText("Modificar");
