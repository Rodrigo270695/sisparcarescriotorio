...
import com.parcar.view.modal.MdGestionarTipoVehiculo;
...
public class FrmGestionarTipoVehiculo extends javax.swing.JInternalFrame {

    public static TipoVehiculoController tipoC = new TipoVehiculoController();
    
    public FrmGestionarTipoVehiculo() {
        initComponents();
        listar("");
    }
    ...
    public static void listar(String texto){
        ...
        if (txtBuscar.getText().length() == 0) {
            ...
            lista = tipoC.listar(texto);
        }
        
        for (Object obj : lista) {
            
            tipoV = (TipoVehiculo) obj;
            ...
            modelo.addRow(new Object[]{
                tipoV.getTipoVehiculoId(),
                tipoV.getDescripcion(),
                botonModificar,
                botonEliminar,
                botonVer
            });
        ...
        tblListado.getColumnModel().getColumn(1).setPreferredWidth(505);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        MdGestionarTipoVehiculo frm = new MdGestionarTipoVehiculo();
                ...
                switch (boton.getName()) {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            MdGestionarTipoVehiculo.idTipoVehiculo = id;
                            FrmMenuPrincipal.centrarVentana(new MdGestionarTipoVehiculo());
                            MdGestionarTipoVehiculo.btnGrabar.setText("Modificar");
                    ...
                    case "btnVer" -> {
                        if (filas == 0) {
                            ...
                            MdGestionarTipoVehiculo.vista = true;
                            MdGestionarTipoVehiculo.idTipoVehiculo = id;
                            FrmMenuPrincipal.centrarVentana(new MdGestionarTipoVehiculo());
                        }
                    }
