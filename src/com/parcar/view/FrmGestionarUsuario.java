...
import com.parcar.view.modal.MdGestionarUsuario;
...
public class FrmGestionarUsuario extends javax.swing.JInternalFrame {
    ...
    public static void listar(String texto) {
        ...
        String columnas[] = {"#", "Documento", "Nombre", "Edad", "Telefono","", "", ""};
        ...
        for (Object obj : lista) {
            ...
            modelo.addRow(new Object[]{
                ...
                hoy.getYear() - usuario.getFechaNacimiento().getYear() - 1900,
                usuario.getTelefono(),
                botonModificar,
                botonEliminar,
                botonVer
        ...
        tblListado.getColumnModel().getColumn(4).setPreferredWidth(140);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        MdGestionarUsuario frm = new MdGestionarUsuario();
                ...
                switch (boton.getName()) {
                    ...
                    case "btnModificar" -> {
                        if (filas == 0) {//si no elije ninguna fila
                            ...
                            MdGestionarUsuario.idUsuario = id;
                            FrmMenuPrincipal.centrarVentana(new MdGestionarUsuario());
                            MdGestionarUsuario.btnGrabar.setText("Modificar");
