...
import com.parcar.view.FrmGestionarTipoVehiculo;
...
public final class MdGestionarTipoVehiculo extends javax.swing.JInternalFrame {

    TipoVehiculoController tipoC = new TipoVehiculoController();
    public static int idTipoVehiculo = 0;
    public static boolean vista = false;

    public MdGestionarTipoVehiculo() {
        initComponents();
        acciones();
    }
    ...
    void acciones() {
        ...
        if (idTipoVehiculo > 0) {
            ...
            TipoVehiculo tipoV = (TipoVehiculo) tipoC.obtenerObjecto(idTipoVehiculo);
            txtDescripcion.setText(tipoV.getDescripcion());
    ...
    void grabar() {
        ...
        TipoVehiculo tipoV = new TipoVehiculo(txtDescripcion.getText().toUpperCase());

        if (btnGrabar.getText().equalsIgnoreCase("Grabar")) {

            try {
                tipoC.registrar(tipoV);
                FrmGestionarTipoVehiculo.listar("");
                AlertaBien alertaB = new AlertaBien("MENSAJE", "Se registro correctamente el tipo");
                this.dispose();
            } catch (Exception e) {
            ...
            try {
                tipoV.setTipoVehiculoId(idTipoVehiculo);
                tipoC.editar(tipoV);
                FrmGestionarTipoVehiculo.listar("");
                AlertaBien alertaB = new AlertaBien("MENSAJE", "Se actualizó correctamente el tipo");
                this.dispose();
            } catch (Exception e) {
                AlertaError alertaError = new AlertaError("ERROR", e.getMessage());
            }
